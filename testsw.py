...
def switch_features_handler(self,ev):
    ...
    #宣告self logger.info為紀錄訊息
    dp=ev.msg.datapath
    #儲存openflow交換器的ryu.controller.Datapath的實體
    ofp=dp.ofprotos
    #解析openflow訊息函式庫
    ...
    #宣告actions為parser用OFPActionOutput class
    #原為OFPP_CONTROLLER(轉送到Controller的Packet-in訊息)，可嘗試改為OFPP_ALL（轉送到除了來源以外的所有port）
